...
const PaymentMethod: React.FC<PaymentProps> = ({ paymentMethod }) => {
    return (
        <>
            ...
            {paymentMethod && (
                <div>
                    <div>Use your Stripe account to make changes to the payment settings</div>
                    <div> Stripe account</div>
                    {paymentMethod.card?.brand} **** **** **** {paymentMethod.card?.last4} exp:{' '}
            ...
            {!paymentMethod && (
                <div>
                    You&apos;ll NEVER be charged until you connect with a Skill and we&apos;ll ALWAYS let you know
