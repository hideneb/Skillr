		...
		<div>
			...
			<main className={styles.main}>
				...
				<p className={styles.accessible}>
					Want to tap into the minds of tutors, cooks, musicians and more? From sketchers to
					stretchers, top crafters to tech-heads, there’s a world of people ready to share what they
					know.
				</p>
				<DownloadApp
					ref={inviteRef}
				...
				<Section
					...
					description={
						<>
							<p>
								Trying your hand at DIY? Got that awkward essay to write? Want to flex it up with
								some yoga? Or, y&apos;know, whatever else you&apos;re up to... In a matter of
								moments, you could be talking to a real life pro who&apos;ll take you through it and
				...
				<Section
					...
					description={
						<p>
							...
							something and need some inspo, if you&apos;ve suddenly been struck by a glaring gap in
							your knowledge, or you&apos;ve just left it super last minute, you can connect to an
							expert Skillr. Like, right there and then. Instantly. With a single tap.
						</p>
					}
					flip
				/>
					...
					description={
						<>
							<p className={styles.noMargin}>
								Got your own skills? Well we&apos;ve got a whole app-load of users wanting to get
								their hands on you. Grab some cash from your know-how in fitness, sport, beauty,
								languages, cooking, DIY, tech, and pretty much anything else. Just think how many
