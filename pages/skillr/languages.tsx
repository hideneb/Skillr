...
const SkillrLanguages: React.FC<SkillrLanguagesProps> = ({
  skillrDDto,
  languages,
}) => {
  ...
  const skillrLanguageIds = skillrLanguages.map(
    (skillrLanguage) => skillrLanguage.id
  );
...
export const getServerSideProps: GetServerSideProps<SkillrLanguagesProps> =
  async (context) => {
