...
const SkillrAvailabilty: React.FC<SkillrAvailabilityProps> = ({
  skillrDDto,
}) => {
  const localAvailability = skillrDDto.localAvailability;

  const [timezoneOffset, setTimezoneOffset] = useState<number>(
    localAvailability.timezoneOffset
  );

  const [day0Begin, setDay0Begin] = useState<string>(
    localAvailability.day0Begin
  );
  const [day0End, setDay0End] = useState<string>(localAvailability.day0End);
  const [day1Begin, setDay1Begin] = useState<string>(
    localAvailability.day1Begin
  );
  const [day1End, setDay1End] = useState<string>(localAvailability.day1End);
  const [day2Begin, setDay2Begin] = useState<string>(
    localAvailability.day2Begin
  );
  const [day2End, setDay2End] = useState<string>(localAvailability.day2End);
  const [day3Begin, setDay3Begin] = useState<string>(
    localAvailability.day3Begin
  );
  const [day3End, setDay3End] = useState<string>(localAvailability.day3End);
  const [day4Begin, setDay4Begin] = useState<string>(
    localAvailability.day4Begin
  );
  const [day4End, setDay4End] = useState<string>(localAvailability.day4End);
  const [day5Begin, setDay5Begin] = useState<string>(
    localAvailability.day5Begin
  );
  const [day5End, setDay5End] = useState<string>(localAvailability.day5End);
  const [day6Begin, setDay6Begin] = useState<string>(
    localAvailability.day6Begin
  );
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            step="1"
            value={day0End}
            onChange={(event) => setDay0End(event.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            step="1"
            value={day1End}
            onChange={(event) => setDay1End(event.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            step="1"
            value={day2End}
            onChange={(event) => setDay2End(event.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            step="1"
            value={day3End}
            onChange={(event) => setDay3End(event.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            step="1"
            value={day4End}
            onChange={(event) => setDay4End(event.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            step="1"
            value={day5End}
            onChange={(event) => setDay5End(event.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            step="1"
            value={day6End}
            onChange={(event) => setDay6End(event.target.value)}
          />
        </div>
...
export const getServerSideProps: GetServerSideProps<SkillrAvailabilityProps> =
  async (context) => {
