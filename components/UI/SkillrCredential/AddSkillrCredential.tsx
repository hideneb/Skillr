...
const allowedMimeTypes = ['application/pdf', 'application/rtf', 'image/jpeg', 'image/png', 'video/mp4'];

type AddSkillrCredentialProps = {
    skillrSkillId: string;
};

const AddSkillrCredential: React.FC<AddSkillrCredentialProps> = ({ skillrSkillId }) => {
