...
const SkillrCredential: React.FC<SkillrCredentialProps> = ({ skillrSkillId, credential }) => {
    ...
    return (
        <>
            ...
            <ExistingMedia id={credential.id} baseForm={baseForm} media={{ url: credential.url }} allowUpdate={true} />
        </>
    );
};
