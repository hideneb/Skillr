...
export default function StepsController({ current, onNextClick, isNextDisabled }: StepsControllerProps) {
    ...
    return (
        <div className="flex space-x-6 items-center fixed bottom-0 w-full z-10 left-0 p-4 md:p-0 bg-white md:static shadow-skillr-lg md:shadow-none pt-4 justify-center">
            <button
